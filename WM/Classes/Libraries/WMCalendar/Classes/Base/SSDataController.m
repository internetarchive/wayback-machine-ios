...
- (void)setCalendarYearsWithValue:(NSArray *)values {
    ...
    for (int i = 0; i < values.count; i++) {
        SSYearNode * yearNode = [[SSYearNode alloc] initWithValue:[[values objectAtIndex:i] integerValue]];
        [tmpArray addObject:yearNode];
    }
    self.calendarYears = [NSArray arrayWithArray:tmpArray];
}
